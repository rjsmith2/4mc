self.ThreeBSP = (function() {
	...
	ThreeBSP.Polygon.prototype.clone = function() {
		...
		for ( i = -1, vertice_count = this.vertices.length; ++i < vertice_count;) {
	...
	ThreeBSP.Polygon.prototype.splitPolygon = function( polygon, coplanar_front, coplanar_back, front, back ) {
		...
		if ( classification === COPLANAR ) {
			...
			front[front.length]=( polygon );
			
		} else if ( classification === BACK ) {
			
			back[back.length]=( polygon );
			...
			for ( i = -1, vertice_count = polygon.vertices.length; ++i < vertice_count;) {
				...
				if ( ti != BACK ) f[f.length]=( vi );
				if ( ti != FRONT ) b[b.length]=( vi );
				if ( (ti | tj) === SPANNING ) {
	...
	ThreeBSP.Node = function( polygons ) {
		...
		for ( i = -1, polygon_count = polygons.length; ++i < polygon_count; ) {
	...
	ThreeBSP.Node.prototype.clone = function() {
		var node = new cachedThreeBSPNode();
